    ...
    <ScreenContentTemplate className={className}>
      ...
      <ScreenContentTemplate.Content className={styles.content}>
        ...
        <div className={styles.buttons}>
          <Button className={styles.button} variant='secondary' size='sm' onClick={handleOpenVacancies}>Откликнуться</Button>
          <Button className={styles.button} variant='tertiary' size='sm' onClick={handleNext}>
            Ещё факты
